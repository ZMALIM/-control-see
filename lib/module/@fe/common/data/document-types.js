export const documentTypes = [
    ...
    {
        code: '14',
        description: 'RECIBO SERVICIOS PUBLICOS'
    },
    {
        code: '16',
    ...
    {
        code: '40',
        description: 'COMPROBANTE DE PERCEPCION'
    },
    {
        code: '41',
        description: 'COMPROBANTE DE PERCEPCION – VENTA INTERNA (FÍSICO-FORMATO IMPRESO'
    },
    {
        code: '56',
    ...
    {
        code: '72',
        description: 'GUIA DE REMISION TRANSPORTISTA COMPLEMENTARIA'
    }
];
