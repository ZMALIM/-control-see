...
const { KEY_INFO } = constants_1.prefix;
...
__decorate([
    xml_serializer_ts_1.XMLChild({ namespace: '' }),
    __metadata("design:type", X509Data_1.X509Data)
], KeyInfo.prototype, "X509Data", void 0);
KeyInfo = __decorate([
    xml_serializer_ts_1.XMLElement({ root: KEY_INFO }),
