...
const PartyIdentificationId_1 = require("./PartyIdentificationId");
...
__decorate([
    ...
    __metadata("design:type", PartyIdentificationId_1.PartyIdentificationId)
], PartyIdentification.prototype, "id", void 0);
__decorate([
    xml_serializer_ts_1.XMLAttribute({ namespace: CBC }),
