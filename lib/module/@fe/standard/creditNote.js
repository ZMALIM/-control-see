...
const { CREDIT_NOTE, EXT, CAC, CBC } = constants_1.prefix;
let CreditNote = class CreditNote {
    constructor() {
        this.xmlns = constants_1.Namespaces.xmlnsCreditNote;
...
__decorate([
    xml_serializer_ts_1.XMLChild({ namespace: CAC, name: 'DiscrepancyResponse' }),
    __metadata("design:type", Array)
], CreditNote.prototype, "discrepancyResponses", void 0);
__decorate([
    xml_serializer_ts_1.XMLChild({ namespace: CAC, name: 'BillingReference' }),
    __metadata("design:type", Array)
...
__decorate([
    xml_serializer_ts_1.XMLChild({ namespace: CAC, name: 'CreditNoteLine' }),
    __metadata("design:type", Array)
], CreditNote.prototype, "creditNoteLines", void 0);
CreditNote = __decorate([
    xml_serializer_ts_1.XMLElement({ root: CREDIT_NOTE }),
