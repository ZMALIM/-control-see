...
let AddressLine = class AddressLine {
    constructor(al) {
        this.line = al.line;
    }
};
__decorate([
    xml_serializer_ts_1.XMLChild({ namespace: CBC, name: 'Line' }),
    __metadata("design:type", String)
], AddressLine.prototype, "line", void 0);
AddressLine = __decorate([
    xml_serializer_ts_1.XMLElement({ root: CAC }),
    __metadata("design:paramtypes", [AddressLine])
], AddressLine);
exports.AddressLine = AddressLine;
//# sourceMappingURL=AddressLine.js.map