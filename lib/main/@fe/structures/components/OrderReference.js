...
let OrderReference = class OrderReference {
    constructor(or) {
        this.id = or.id;
    }
};
...
], OrderReference.prototype, "id", void 0);
OrderReference = __decorate([
    xml_serializer_ts_1.XMLElement({ root: CAC }),
    __metadata("design:paramtypes", [OrderReference])
], OrderReference);
exports.OrderReference = OrderReference;
//# sourceMappingURL=OrderReference.js.map