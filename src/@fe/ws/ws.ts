...
import { WSConfig, ResponseWS, PDocument, ErrorWS, PStatusCDR } from '@fe/common/exchange';
...
export class WS 
{
     ...
     * @description
     * @auth
     * @param wsConfig ConexionSoap
     * @return void
     *
     */
    public async auth(wsConfig: WSConfig): Promise<void> 
    {
        try {
